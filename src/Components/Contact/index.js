...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (
      ...
      if (validateEmail(from_email)) {
        emailjs.send("service_2we3x4d", "template_9cb95hl", {
          from_name: fromName,
  ...
  emailjs.init("user_1VC-6xREyB4bj-NqF");
...
//     emailjs.sendForm('service_2we3x4d', 'template_9cb95hl', form.current, '1VC-6xREyB4bj-NqF')
//       .then((result) => {
